"""
Enqueue a score-fight Pub/Sub job.
"""
...
class Command(BaseCommand):
    help = "Publish a score-fight scoring job to Pub/Sub"
    ...
    def handle(self, *args, **options) -> None:
        ...
        topic_id = os.getenv("PUBSUB_SCORE_FIGHT_TOPIC", "score-fight-jobs")
        ...
        try:
            ...
            raise CommandError(f"Failed to publish score-fight job: {exc}") from exc

        self.stdout.write(
            self.style.SUCCESS(
                f"Published score-fight job message_id={message_id} "
