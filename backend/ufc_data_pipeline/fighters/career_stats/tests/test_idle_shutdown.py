"""
Tests for career-stats subscriber idle shutdown behavior.
"""
...
class CareerStatsIdleShutdownTests(SimpleTestCase):
    ...
    @patch.dict(
        os.environ,
        {
            ...
            "PUBSUB_CAREER_STATS_SUBSCRIPTION": "career-stats-jobs-sub",
    ...
    @patch("ufc_data_pipeline.fighters.career_stats.consumer.MAX_MESSAGES", 3)
    @patch("ufc_data_pipeline.fighters.career_stats.consumer.pubsub_v1.SubscriberClient")
    @patch("ufc_data_pipeline.fighters.career_stats.consumer.ensure_django")
    def test_run_subscriber_shuts_down_when_idle_enabled(
        ...
        with patch(
            "ufc_data_pipeline.fighters.career_stats.consumer.monotonic",
            return_value=10.0,
        ):
