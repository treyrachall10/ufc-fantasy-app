...
export default function DraftLobbyPage() {
    ...
    const [draftAnnouncement, setDraftAnnouncement] = useState<{ team: string, fighter: string } | null>({ team: 'Adan', fighter: 'ffe' });
    ...
    const draftFighterMutation = useMutation({
        ...
        onSuccess: (data) => {
            ...
            setDraftAnnouncement({ team: 'Team Name', fighter: 'Fighter Name' });
                    ...
                    <AnimatePresence>
                        {draftAnnouncement && (
                            <Box
                                ...
                                <Typography variant="h2" sx={{ color: 'whiteAlpha100.main' }}>
                                    {draftAnnouncement.team} drafted {draftAnnouncement.fighter}
                                </Typography>
                            </Box>
                        )}
                    </AnimatePresence>
                        ...
                        <Grid size={{ xs: 12, md: 6, lg: 7 }}>
                            <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', justifyContent: 'flex-start', overflowX: 'hidden', pb: 1, width: '100%' }}>
                                {draftState.upcomingPicks.map((item: any, index) => {
                                    ...
                                    // Ignores  seperators to for upcoming picks to alternate colors
